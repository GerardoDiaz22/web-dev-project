...
const eliminargrade = async (grade) => {
  ...
  isLoading.value = true;
  try {
    const gradeDocRef = doc(db, 'grades', grade.id);
...
const exportToExcel = () => {
  ...
  const success = generateExcelReport(
      dataToExport,
      columnMapping,
      'reporte_calificaciones', // Nombre base del archivo
      'Calificaciones'          // Nombre de la hoja
   );
                        ...
                        >
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                >
                                    ...
                                    <div class="py-1">
                                        <a href="#" @click.prevent="eliminargrade(item)" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Eliminar</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
